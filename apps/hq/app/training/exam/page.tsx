...
export default function BoardExamPage() {
    ...
    useState(() => {
        // Simple client-side-only init
        if (typeof window !== 'undefined') {
            // Note: In production this would be generated by the backend
        }
    });

    useEffect(() => {
        setCertificateId(`AIC-LA-2026-${Math.random().toString(36).substring(7).toUpperCase()}`);
    }, []);
