                    ...
                    {loading ? (
                        ...
                        >
                            ...
                            <div className="bg-black/40 border border-white/5 p-6 rounded-xl mb-8">
                                <p className="text-[10px] font-mono font-bold text-gray-400 uppercase tracking-widest mb-4">Evidence URL</p>
                                {req.evidence_url ? (
                            ...
                            <div className="mb-8">
                                <p className="text-[10px] font-mono font-bold text-gray-400 uppercase tracking-widest mb-4">Auditor Findings / Remediation Advice</p>
                                <textarea 
