        ...
        <div className="space-y-12">
            <div className="flex justify-between items-end border-b border-aic-paper/5 pb-12">
                ...
                <div className="text-right">
                    ...
                    <div className="text-2xl font-serif text-aic-paper uppercase tracking-widest">Optimal</div>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    { l: 'Total Audits Processed', v: stats.totalAudits.toLocaleString(), c: 'text-aic-paper' },
            ...
            <div className="bg-[#080808] border border-aic-paper/5 rounded-[3rem] p-12 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="p-8 bg-aic-paper/5 border border-aic-paper/10 rounded-3xl">
                    ...
                    <div className="space-y-4">
                        {['ENGINE_NODE_ZA_01', 'ENGINE_NODE_ZA_02', 'ENGINE_NODE_MU_01'].map(node => (
                            <div key={node} className="flex justify-between items-center p-4 bg-black rounded-xl border border-aic-paper/5 font-mono text-[9px]">
                                <span className="text-aic-paper">{node}</span>
