...
:apps/platform/app/(modules)/hq/training/curriculum/bias-methodology/page.tsx
                <Link href="/training" className="text-[10px] font-mono font-bold text-gray-500 hover:text-aic-paper transition-colors uppercase tracking-widest">:apps/hq/app/training/curriculum/bias-methodology/page.tsx
                    ← Back to Training Hub
                </Link>
                <div className="flex gap-2">
                    {lessons.map((_, i) => (
:apps/platform/app/(modules)/hq/training/curriculum/bias-methodology/page.tsx
                        <div key={i} className={`h-1 w-16 rounded-full transition-all duration-500 ${i === step ? 'bg-aic-gold shadow-[0_0_10px_rgba(212,175,55,0.5)]' : 'bg-aic-paper/5'}`} />:apps/hq/app/training/curriculum/bias-methodology/page.tsx
                    ))}
                </div>
            </div>
...
:apps/platform/app/(modules)/hq/training/curriculum/bias-methodology/page.tsx
                    ...
                    <div className="bg-[#080808] border border-aic-paper/5 p-16 rounded-[3rem] shadow-2xl relative overflow-hidden">:apps/hq/app/training/curriculum/bias-methodology/page.tsx
...
:apps/platform/app/(modules)/hq/training/curriculum/bias-methodology/page.tsx
                        <div className="bg-black border border-aic-paper/5 p-8 rounded-2xl font-mono text-[10px] text-aic-gold/80 flex items-center justify-between">:apps/hq/app/training/curriculum/bias-methodology/page.tsx
...
:apps/platform/app/(modules)/hq/training/curriculum/bias-methodology/page.tsx
            <div className="flex justify-between pt-12 border-t border-aic-paper/5">
                <button 
                    ...
                    disabled={step === 0}
                    className="px-10 py-4 font-mono text-[10px] font-bold text-gray-500 hover:text-aic-paper transition-all disabled:opacity-0":apps/hq/app/training/curriculum/bias-methodology/page.tsx
                >
                    PREVIOUS_MODULE
                </button>
                <button 
...
:apps/platform/app/(modules)/hq/training/curriculum/bias-methodology/page.tsx
                    className="bg-aic-paper text-black px-12 py-4 font-mono text-[10px] font-bold uppercase tracking-widest hover:bg-aic-gold transition-all shadow-xl":apps/hq/app/training/curriculum/bias-methodology/page.tsx
                >
