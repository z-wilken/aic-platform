      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-4 items-start">
            ...
            <div className="divide-y divide-[#f3f4f6]">
              {AGREEMENTS.map((a) => (
                <div key={a.id} className="flex items-center gap-3 py-2.5">
                  ...
                  <button className="text-[#9ca3af] hover:text-[#c9920a] transition-colors flex-shrink-0">
        ...
        <div className="space-y-3">
          ...
          <SectionCard className="p-4">
            ...
            <button className="w-full mt-3 inline-flex items-center justify-center gap-2 font-mono text-[9px] font-bold text-[#6b7280] border border-[#e5e7eb] rounded-full py-2 hover:border-[#c9920a] hover:text-[#c9920a] transition-colors">
          ...
          <SectionCard className="p-4">
            ...
            <button className="w-full mt-3 inline-flex items-center justify-center gap-2 font-mono text-[9px] font-bold text-[#9ca3af] border border-dashed border-[#e5e7eb] rounded-full py-2 hover:border-[#c9920a] hover:text-[#c9920a] transition-colors">
