    ...
    <div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#A35139] text-sm uppercase tracking-widest">Corporate Portal</span>
          </div>
          <h1 className="text-5xl text-aic-paper mb-4" style={{ fontFamily: "'Merriweather', serif", fontWeight: 700 }}>
            ...
            <span className="text-[#A35139]">for Your Organization</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="bg-[#A35139] text-aic-paper px-6 py-3 rounded-lg text-sm font-medium hover:bg-[#A35139] transition-colors"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        {activeTab === "certification" && (
          <div>
            <div className="text-center mb-12">
              <span className="text-[#A35139] text-sm uppercase tracking-widest">ISO/IEC 42001</span>
              <h2 className="text-3xl text-[#1B2632] mt-2 mb-3" style={{ fontFamily: "'Merriweather', serif" }}>
        ...
        {activeTab === "gap" && (
          <div>
            <div className="mb-10">
              <span className="text-[#A35139] text-sm uppercase tracking-widest">Free Tool</span>
              <h2 className="text-3xl text-[#1B2632] mt-2 mb-3" style={{ fontFamily: "'Merriweather', serif" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
              <div className="md:col-span-1 bg-[#1B2632] rounded-2xl p-6 text-aic-paper text-center">
                <div className="text-5xl font-bold text-[#A35139]">61%</div>
                ...
                <div className="mt-4 h-2 bg-aic-paper/10 rounded-full">
                  <div className="h-2 rounded-full bg-[#A35139]" style={{ width: "61%" }}></div>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-[#1B2632] rounded-2xl text-center">
              ...
              <button className="bg-[#A35139] text-aic-paper px-8 py-3 rounded-lg text-sm font-medium hover:bg-[#A35139] transition-colors">
        ...
        {activeTab === "templates" && (
          <div>
            <div className="mb-10">
              <span className="text-[#A35139] text-sm uppercase tracking-widest">Resources</span>
              <h2 className="text-3xl text-[#1B2632] mt-2 mb-3" style={{ fontFamily: "'Merriweather', serif" }}>
        ...
        {activeTab === "directory" && (
          <div>
            <div className="mb-10">
              <span className="text-[#A35139] text-sm uppercase tracking-widest">Public Directory</span>
              <h2 className="text-3xl text-[#1B2632] mt-2 mb-3" style={{ fontFamily: "'Merriweather', serif" }}>
            ...
            <div className="relative mb-6 max-w-md">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 border border-[#DDD3C0] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1B2632]/20"
                value={searchOrg}
