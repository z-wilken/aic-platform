      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-aic prose-lg max-w-none">
            <p className="text-[#6B6458]/60 mb-12 italic font-mono text-sm uppercase tracking-widest">Last Updated: April 2026</p>
            ...
            <div className="grid md:grid-cols-3 gap-6 my-12">
              {[
                ...
                <div key={i} className="p-8 bg-aic-paper rounded-2xl border border-[#DDD3C0] shadow-sm">
                  {item.icon}
            ...
            <p className="text-[#6B6458] mb-4 text-lg leading-relaxed">
            ...
            <div className="bg-aic-paper rounded-2xl p-8 mb-8 space-y-5">
              {[
                ...
                <div key={i} className="flex gap-4">
                  ...
                  <p className="text-[#1B2632] text-base leading-relaxed"><strong>{item.label}:</strong> {item.desc}</p>
                </div>
              ))}
            </div>
            <p className="text-[#6B6458] mb-8 text-lg leading-relaxed">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={i} className="border border-[#DDD3C0] rounded-xl p-6">
                  <p className="font-bold text-aic-navy mb-1">{item.basis}</p>
                  <p className="text-[#6B6458] text-sm leading-relaxed">{item.reason}</p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-aic-paper rounded-2xl p-8 mb-8 space-y-4">
              {[
                ...
                <div key={i} className="flex gap-3 items-start">
                  ...
                  <p className="text-[#1B2632] text-base leading-relaxed" dangerouslySetInnerHTML={{ __html: item }} />
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={i} className="border border-[#DDD3C0] rounded-xl p-6">
                  ...
                  <p className="text-[#6B6458] text-sm leading-relaxed">{item.what}</p>
                </div>
              ))}
            </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} className={i % 2 === 0 ? "bg-aic-paper" : "bg-aic-paper"}>
                      <td className="p-4 text-[#1B2632]">{cat}</td>
                      <td className="p-4 text-[#1B2632] font-mono text-xs">{period}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {[
                ...
                <div key={i} className="p-6 bg-aic-paper border border-[#DDD3C0] rounded-xl shadow-sm">
                  <p className="font-bold text-aic-navy mb-1 font-serif">{item.right}</p>
                  <p className="text-[#6B6458] text-sm leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
            <p className="text-[#6B6458] text-sm leading-relaxed mb-8">
            ...
            <div className="bg-aic-paper border border-[#DDD3C0] rounded-2xl p-10 shadow-sm">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-[#6B6458] mb-1">Zander Wilken</p>
                  <p className="text-[#6B6458] mb-1">AI Integrity Certification (Pty) Ltd</p>
                  <p className="text-[#6B6458] mb-4">South Africa</p>
                  <a href="mailto:zander@ztoaholdings.co.za" className="text-aic-copper underline font-bold text-lg">
                    zander@ztoaholdings.com
                  </a>
                  <p className="text-[#6B6458]/80 text-sm mt-4 leading-relaxed">
