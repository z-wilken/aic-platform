    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <div className="flex items-center gap-2 mb-4">
              <FileText className="w-6 h-6 text-[#c36c32]" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              return (
                ...
                >
                  <Icon className="w-6 h-6 text-[#c36c32] mx-auto mb-2" />
                  <div className="text-sm text-gray-500 mb-1">{item.label}</div>
                  <div className="text-2xl font-bold text-[#0A1728]">{item.value}</div>
                </motion.div>
              );
            })}
          </div>
              ...
              >
                <Card className="p-8">
                  <div className="flex items-start gap-4 mb-6">
                    <div className="w-12 h-12 bg-[#0A1728] rounded-lg flex items-center justify-center shrink-0">
                      <Scale className="w-6 h-6 text-[#c36c32]" />
                    </div>
                    <div>
                      <h2 className="text-2xl font-semibold text-[#0A1728] mb-2">
                  ...
                  <div className="space-y-6 text-gray-700 leading-relaxed">
                    <div>
                      <h3 className="font-semibold text-[#0A1728] mb-2">Core Principle</h3>
                      <p>
                    ...
                    <div>
                      <h3 className="font-semibold text-[#0A1728] mb-2">Independence Safeguards</h3>
                      <div className="grid md:grid-cols-2 gap-4">
                        {[
                          ...
                          <div key={i} className="flex items-start gap-3 p-4 bg-aic-paper rounded-lg border border-gray-200">
                            ...
                            <div>
                              <div className="font-medium text-[#0A1728] mb-1">{safeguard.title}</div>
                    ...
                    <div>
                      <h3 className="font-semibold text-[#0A1728] mb-2">Reporting Concerns</h3>
                      <p className="mb-3">
            ...
            <TabsContent value="accreditation">
              ...
              >
                <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h2 className="text-2xl font-semibold text-[#0A1728]">Current Accreditation Status</h2>
                      ...
                      {[
                        ...
                        return (
                          <div key={i} className="flex items-start gap-3 p-4 bg-[#F9F8F4] rounded-lg">
                            <Icon className="w-5 h-5 text-[#c36c32] shrink-0 mt-0.5" />
                            <div>
                              <div className="text-sm text-gray-500 mb-1">{item.label}</div>
                              <div className="font-medium text-[#0A1728]">{item.value}</div>
                            </div>
                          </div>
                        );
                      })}
                  ...
                  <Card className="p-8">
                    <h3 className="font-semibold text-[#0A1728] mb-4">What IAF MLA Recognition Means</h3>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {[
                        ...
                        <div key={i} className="text-center p-4 bg-[#F9F8F4] rounded-lg border border-gray-200">
                          <Globe className="w-6 h-6 text-[#c36c32] mx-auto mb-2" />
                          <div className="font-semibold text-[#0A1728]">{region.region}</div>
                    ...
                    {filteredOrgs.map((org, i) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <div className="flex items-center gap-3 mb-2">
                              <h3 className="font-semibold text-[#0A1728] text-lg">{org.name}</h3>
                              <Badge
                                className={
                                  org.status === "Active"
                        ...
                        <div className="grid md:grid-cols-2 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-mono text-[#0A1728]">{org.certNumber}</div>
                          </div>
                          <div>
                ...
                <div className="space-y-6">
                  <Card className="p-8">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="text-2xl font-semibold text-[#0A1728] mb-2">Appeals and Dispute Resolution</h2>
                        <p className="text-sm text-gray-500">
                    ...
                    <div className="space-y-6 text-gray-700 leading-relaxed">
                      <div>
                        <h3 className="font-semibold text-[#0A1728] mb-3">Grounds for Appeal</h3>
                        ...
                        <ul className="space-y-2">
                          {[
                            ...
                            <li key={i} className="flex items-start gap-2 text-sm">
                              <CheckCircle className="w-4 h-4 text-[#c36c32] shrink-0 mt-0.5" />
                              <span>{ground}</span>
                            </li>
                          ))}
                        </ul>
                      ...
                      <div>
                        <h3 className="font-semibold text-[#0A1728] mb-3">How to File an Appeal</h3>
                        <div className="bg-aic-paper border border-gray-200 rounded-lg p-5">
                          <div className="space-y-3 text-sm">
                            ...
                            <div>
                              ...
                              <a href="#" className="text-[#c36c32] hover:underline">
                  ...
                  <Card className="p-8">
                    <h3 className="font-semibold text-[#0A1728] mb-4">Recent Appeals Activity</h3>
                      ...
                      {appealCases.map((appeal, i) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="w-10 h-10 bg-[#0A1728] rounded-lg flex items-center justify-center text-aic-paper font-mono text-xs">
                              {appeal.caseId.split("-")[2]}
                            </div>
                            <div>
                              <div className="font-medium text-[#0A1728]">{appeal.organization}</div>
                              <div className="text-sm text-gray-500">
      ...
      <section className="py-16 bg-aic-paper border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl text-[#0A1728] mb-4" style={{ fontFamily: "'Merriweather', serif" }}>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Button className="bg-[#0A1728] hover:bg-[#1a3160] text-aic-paper px-8 py-3">Contact Compliance Team</Button>
