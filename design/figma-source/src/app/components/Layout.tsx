    ...
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="bg-[#0a1628] text-white/70 text-xs py-2">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link to="/disclosures" className="hover:text-white transition-colors">Public Disclosures</Link>
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {navItems.map((item) => (
                  <li key={item.href}>
                    <Link to={item.href} className="text-gray-400 hover:text-white text-sm transition-colors flex items-center gap-1.5">
          ...
          <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-xs text-gray-500">
              <Link to="/disclosures" className="hover:text-gray-300 transition-colors">Privacy Policy</Link>
              <Link to="/disclosures" className="hover:text-gray-300 transition-colors">Terms of Use</Link>
              <Link to="/disclosures" className="hover:text-gray-300 transition-colors">Impartiality Statement</Link>
            </div>
          </div>
        </div>
      </footer>
